					...
					<table className="w-full text-left">
						...
						<tbody className="divide-y divide-border-light">
							<tr className="hover:bg-accent/20 transition-colors">
								...
								<td className="p-5 text-sm text-secondary/80 align-top">"Hey! I love your new product. Can I get a discount?"</td>
								<td className="p-5 text-sm text-secondary/80 align-top">"Thanks, Jane! We're so glad you like it. We've just sent you a DM with a special 15% off code."</td>
								<td className="p-5 align-top">
									<span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-success/10 text-success">Handled</span>
								</td>
								<td className="p-5 text-sm font-medium text-secondary/80 text-center align-top">98%</td>
								<td className="p-5 text-sm text-secondary/60 align-top">Mar 12, 2024</td>
								<td className="p-5 align-top">
									<div className="flex items-center gap-2 text-secondary/60">
										<button className="p-1.5 rounded-md hover:bg-secondary/10 hover:text-secondary">
							...
							<tr className="hover:bg-accent/20 transition-colors">
								...
								<td className="p-5 text-sm text-secondary/80 align-top">"My order #12345 hasn't arrived yet. What's the status?"</td>
								<td className="p-5 text-sm text-secondary/80 align-top">"Hi John, I've checked order #12345 and it seems there's a delay. I've escalated this to our support team for you."</td>
								<td className="p-5 align-top">
									<span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-warning/10 text-warning">Needs Review</span>
								</td>
								<td className="p-5 text-sm font-medium text-secondary/80 text-center align-top">76%</td>
								<td className="p-5 text-sm text-secondary/60 align-top">Mar 11, 2024</td>
								<td className="p-5 align-top">
									<div className="flex items-center gap-2 text-secondary/60">
										<button className="p-1.5 rounded-md hover:bg-secondary/10 hover:text-secondary">
											<span className="material-symbols-outlined text-xl">edit</span>
							...
							<tr className="hover:bg-accent/20 transition-colors">
								...
								<td className="p-5 text-sm text-secondary/80 align-top">"This is amazing! 🔥"</td>
								<td className="p-5 text-sm text-secondary/80 align-top">"Thank you so much, Emily! 🙌"</td>
								<td className="p-5 align-top">
									<span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-success/10 text-success">Handled</span>
								</td>
								<td className="p-5 text-sm font-medium text-secondary/80 text-center align-top">99%</td>
								<td className="p-5 text-sm text-secondary/60 align-top">Mar 10, 2024</td>
								<td className="p-5 align-top">
									<div className="flex items-center gap-2 text-secondary/60">
										<button className="p-1.5 rounded-md hover:bg-secondary/10 hover:text-secondary">
											<span className="material-symbols-outlined text-xl">edit</span>
							...
							<tr className="hover:bg-accent/20 transition-colors">
								...
								<td className="p-5 text-sm text-secondary/80 align-top">"When is the new feature launching?"</td>
								<td className="p-5 text-sm text-secondary/80 align-top">"Soon! Keep an eye on our page for the official announcement next week."</td>
								<td className="p-5 align-top">
									<span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-success/10 text-success">Handled</span>
								</td>
								<td className="p-5 text-sm font-medium text-secondary/80 text-center align-top">95%</td>
								<td className="p-5 text-sm text-secondary/60 align-top">Mar 9, 2024</td>
								<td className="p-5 align-top">
									<div className="flex items-center gap-2 text-secondary/60">
										<button className="p-1.5 rounded-md hover:bg-secondary/10 hover:text-secondary">
											<span className="material-symbols-outlined text-xl">edit</span>
